...
class WishesControllerTest < ActionController::TestCase
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post :create, wish: { description: @wish.description, link: @wish.link, price_idea: @wish.price_idea, user_id: @wish.user_id }
    end
  ...
  test "should update wish" do
    patch :update, id: @wish, wish: { description: @wish.description, link: @wish.link, price_idea: @wish.price_idea, user_id: @wish.user_id }
    assert_redirected_to wish_path(assigns(:wish))
  end
